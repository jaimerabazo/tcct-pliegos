-- La función devuelve una columna llamada "organizationId", que PL/pgSQL expone como
-- variable OUT dentro del cuerpo. En `ON CONFLICT ("userId", "organizationId")`, el
-- segundo nombre podía significar tanto esa variable como la columna de memberships y
-- PostgreSQL abortaba con 42702. Referenciar la PK por nombre elimina la ambigüedad.
