...
const AnalysisEmptyState = ({ pliego, onBack }) => (
  <div className="max-w-[1200px]">
    ...
    <div className="px-8 pb-12">
      <div className="rounded-lg border p-12 flex flex-col items-center text-center" style={{ borderColor: '#E5E9F0', background: 'white' }}>
        <div className="w-14 h-14 rounded-full flex items-center justify-center mb-4" style={{ background: '#F0F5FF' }}>
          <FileSearch size={24} color="#0066FF" strokeWidth={1.8} />
        </div>
        <div className="text-[15px] mb-1.5" style={{ fontFamily: '"Space Grotesk", sans-serif', fontWeight: 500, color: '#001B4B' }}>
          Este pliego aún no se ha analizado en detalle
        </div>
        <div className="text-[13px]" style={{ color: '#5B6478', maxWidth: '440px' }}>
